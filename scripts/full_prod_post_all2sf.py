...
ELASTICSEARCH_URLCLASSIFIED_KW = os.getenv("ELASTICSEARCH_URL_CLASSIFIED_KW")
...
# base_url = ELASTICSEARCH_URLCLASSIFIED_KW
...
CREATE OR REPLACE TABLE {SNOWFLAKE_SCHEMA}.prod_posts_all_countries_els (
    ...
    for index in indices:
        ...
        while True:
            ...
            for hit in hits:
                ...
                try:
                    insert_query = """
                        INSERT INTO prod_posts_all_countries_els (
