...
ELASTICSEARCH_URL = os.getenv("ELASTICSEARCH_URL_COMMERCIAL")
...
CREATE OR REPLACE TABLE commercial_log_report_els (
    EntityID INT,
    EntityTitle STRING,
    Breadcrumb STRING,
...
while True:
    ...
    json_data = {
        ...
        'query': {
            'bool': {
                'filter': [
                    {'range': {'created_at': {'gte': '2024-10-01T00:00:00.230Z', 'lte': '2025-01-17T00:00:00.230Z'}}}
                ]
            }
        },
    ...
    insert_query = """
    INSERT INTO commercial_log_report_els (
